...
import com.example.kltn.hospitalappointy.Fragment.Fragment_SectionPagerAdapter;
...
/*        mViewPager = (ViewPager) findViewById(R.id.main_ViewPager);
    ...
    public void onStart() {
        ...
        final MenuItem nav_profile_patient = menuNav.findItem(R.id.nav_profile_patient);
        ...
        final MenuItem nav_switch = menuNav.findItem(R.id.nav_switch);
        ...
        nav_profile_patient.setVisible(false);
...
//                Toast.makeText(MainActivity.this, status+" -"+Type, Toast.LENGTH_SHORT).show();
                ...
                if(Type.equals("Patient")){
                    ...
                    nav_profile_patient.setVisible(true);
